        ...
        <div className="grid gap-4">
          {publications.map((pub, i) => (
            <motion.div
              ...
              className="group flex gap-4 p-5 rounded-2xl border border-slate-800 bg-slate-900/50 hover:border-cyan-800/50 transition-all duration-300"
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-2 flex-wrap">
                  ...
                  <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-cyan-950/50 text-cyan-400 border border-cyan-900/40 flex-shrink-0">
                    {pub.year}
                  </span>
                </div>
              </div>
