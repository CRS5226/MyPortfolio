...
export default function Education() {
  return (
    <section id="education" className="py-28 px-6 bg-slate-900/20 grid-bg">
          ...
          {education.map((edu, i) => (
            ...
            >
              ...
              <div className="relative">
                <span className="px-4 py-1.5 rounded-full text-sm font-bold bg-emerald-950/50 text-emerald-400 border border-emerald-900/40">
                  GPA {edu.gpa}
                </span>
              </div>
            </motion.div>
