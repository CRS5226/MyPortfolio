...
const socialLinks = [
  ...
  },
  {
    ...
    Icon: LinkedinIcon,
    display: "linkedin.com/in/chitraksh-singh",
  },
  {
    label: "GitHub",
    href: personalInfo.github,
    Icon: GithubIcon,
    display: "github.com/CRS5226",
  },
  {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-slate-400 mt-4 max-w-lg mx-auto text-base leading-relaxed">
            Open to new opportunities, research collaborations, and interesting projects. Feel free to reach out.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-widest mb-5">Find me on</h3>
            {socialLinks.map(({ label, href, Icon, display }) => (
              ...
              >
                <div className="w-9 h-9 rounded-lg bg-cyan-950/50 flex items-center justify-center flex-shrink-0 text-primary">
                  <Icon />
                </div>
                <div>
          ...
          >
            <h3 className="text-sm font-semibold text-slate-500 uppercase tracking-widest mb-5">Send a message</h3>
            <form
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  required
                  placeholder="Hi Chitraksh, I'd like to..."
