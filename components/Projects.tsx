        ...
        <div className="grid gap-6">
          {projects.map((project, i) => (
            <motion.div key={project.name}
              ...
              className="group relative p-7 rounded-2xl border border-slate-800 bg-slate-900/70 backdrop-blur-sm hover:border-cyan-800/50 transition-all duration-300 overflow-hidden">
              ...
              <ul className="space-y-2.5 mb-6">
                {project.highlights.map((h, j) => (
                  <motion.li key={j}
                    ...
                    viewport={{ once: true }} transition={{ duration: 0.4, delay: j * 0.07 }}
