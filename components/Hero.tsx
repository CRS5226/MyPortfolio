    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <a
            href="#experience"
            className="group relative px-8 py-3 rounded-lg bg-primary text-slate-950 font-semibold text-sm overflow-hidden transition-all hover:shadow-lg hover:shadow-cyan-900/40"
          >
          ...
          <a
            href="#contact"
            className="px-8 py-3 rounded-lg border border-slate-700 text-slate-400 font-semibold text-sm hover:border-primary hover:text-primary transition-all duration-300"
          >
            Contact Me
          </a>
        </motion.div>
        ...
        >
          {[
            ...
            <a
              ...
              aria-label={label}
              className="text-slate-600 hover:text-primary transition-colors duration-200 hover:scale-110 transform"
            >
              {svg}
            </a>
          ))}
